...
function createGameOver(thus) {
  gameOverImage = thus.add.image(500, 100, "gameover").setScale(0.7);
  clearImage = thus.add.image(500, 100, "clear").setScale(0.7);
  tryAgainImage = thus.add.image(500, 280, "tryagain").setScale(0.7);
  yesImage = thus.add.image(420, 360, "yes").setScale(0.7);
  noImage = thus.add.image(580, 360, "no").setScale(0.7);
...
const game = {
  ...
  scene: {
    preload: function () {
      ...
      this.load.image("gameover", "assets/Object/gameover.png");
      ...
      this.load.image("clear", "assets/Object/clear.png");
    },
    create: function () {
